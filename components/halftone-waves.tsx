...
export default function HalftoneWaves() {
    ...
    const drawHalftoneWave = () => {
      ...
      for (let y = 0; y < rows; y++) {
        for (let x = 0; x < cols; x++) {
          ...
          // Using a blue color palette for pharmacy/medical theme
          ctx.fillStyle = `rgba(59, 130, 246, ${waveOffset * 0.5})`
          ctx.fill()
        }
      }
    }
  ...
  return <canvas ref={canvasRef} className="fixed top-0 left-0 w-full h-screen -z-10 bg-white opacity-40" />
}
